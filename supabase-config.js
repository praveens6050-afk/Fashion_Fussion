...
(function(){'use strict';
  ...
  function start(){
    ...
    if(page==='account.html'){add('account-stability.js?v=2','data-account-stability');add('account-role-guard.js?v=2','data-account-role-guard');add('support-chat.js?v=8','data-support-chat');add('account-refunds.js?v=1','data-account-refunds');add('account-returns.js?v=2','data-account-returns');add('account-business.js?v=4','data-account-business');add('account-repeat-order.js?v=1','data-account-repeat-order');add('account-cancel-promotion.js?v=1','data-account-cancel-promotion')}
