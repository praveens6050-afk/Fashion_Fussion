...
(function(){'use strict';
  ...
  function start(){
    ...
    if(page==='account.html'){add('account-role-guard.js?v=2','data-account-role-guard');add('support-chat.js?v=8','data-support-chat');add('account-refunds.js?v=1','data-account-refunds')}
    if(page==='order-details.html'){add('order-refund-tracker.js?v=1','data-order-refund-tracker')}
