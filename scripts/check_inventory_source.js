...
const productGrantMigration=requireMarkers('supabase/migrations/20260915170925_restore_product_feature_column_select.sql',['bulk_enabled','bulk_min_qty','has_variants','to anon, authenticated']);
...
const activationMigration=requireMarkers('supabase/migrations/20260915174838_guard_product_activation_inventory.sql',['alter column is_active set default false','products_activation_readiness_guard','Add at least one SKU/variant before activating this product','Set available stock above zero on an active SKU before activating this product','i.on_hand - i.reserved']);
