...
const loader=requireMarkers('supabase-config.js',["admin-checkout-health.js?v=1','data-admin-checkout-health"]);
...
if(!loader.includes("page==='admin.html'"))errors.push('supabase-config.js: checkout readiness UI must remain admin-only');
if(errors.length){console.error(errors.join('\n'));process.exit(1)}
console.log('Checkout readiness source guards passed');
