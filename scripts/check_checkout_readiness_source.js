...
const loader=requireMarkers('supabase-config.js',["admin-checkout-health.js?v=1','data-admin-checkout-health","admin-launch-readiness.js?v=1','data-admin-launch-readiness"]);
