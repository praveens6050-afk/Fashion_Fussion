...
for(const required of ["variant-commerce.js?v=2','data-variant-commerce", "product-variants.js?v=2','data-product-variants", "variant-cart-ui.js?v=1','data-variant-cart-ui", "order-refund-tracker.js?v=1','data-order-refund-tracker", "account-refunds.js?v=1','data-account-refunds", "order-return-exchange.js?v=1','data-order-return-exchange", "account-returns.js?v=2','data-account-returns", "account-business.js?v=4','data-account-business", "order-business-details.js?v=1','data-order-business-details", "admin-business-quotes.js?v=3','data-admin-business-quotes"])if(!supabaseConfig.includes(required))errors.push(`supabase-config.js: customer/admin commerce runtime injector missing ${required}`);
for(const required of ["page==='order-details.html'","order-refund-tracker.js?v=1","data-order-refund-tracker"])if(!supabaseConfig.includes(required))errors.push(`supabase-config.js: order refund tracker route guard missing ${required}`);
