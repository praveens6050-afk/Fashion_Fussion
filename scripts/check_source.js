...
for(const required of ["order-refund-tracker.js?v=1','data-order-refund-tracker", "account-refunds.js?v=1','data-account-refunds", "order-return-exchange.js?v=1','data-order-return-exchange", "account-returns.js?v=2','data-account-returns", "account-business.js?v=3','data-account-business", "order-business-details.js?v=1','data-order-business-details"])if(!supabaseConfig.includes(required))errors.push(`supabase-config.js: customer commerce runtime injector missing ${required}`);
