...
if(sellerPath!=='login'&&sellerPath!=='login.html'&&!window.__sellerLiveIntegrationRequested){window.__sellerLiveIntegrationRequested=true;const script=document.createElement('script');script.src='seller-live-integration.js';script.async=false;document.head.appendChild(script)}
