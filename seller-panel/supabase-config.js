...
if(!isSellerLogin){
  ...
  if(!document.querySelector('script[data-seller-support]')){const support=document.createElement('script');support.src='seller-support.js?v=1';support.async=false;support.setAttribute('data-seller-support','true');document.head.appendChild(support)}
